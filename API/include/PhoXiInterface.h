  ...
  public:
    ...
    */
    ...
    @param CustomMessage - Custom string that will be transfered and attached
        ...
        In case of unsuccessful frame the CustomMessage field will contain
        the specific error message (need at least PhoXiControl-1.6.0).
    ...
    */
    ...
    @param jsonOptions - (optional) Configure save operations with options. If empty, then options
           from PhoXi Control configuration will be applied.
    @return true on success, false otherwise.
    ...
    */
    virtual bool SaveLastOutput(const std::string &FilePath, int FrameID = -1, const std::string& jsonOptions = "");
    ...
    */
    ...
    ///Result of StartRecording operation
    enum class StartRecordingResult {
        Success = 0,
        Failure = -1,
        DeviceNotConnected = -2,
        FailedToParseJson = -3,
        FailedToSetOptions = -4,
        FailedToPersistOptions = -5,
        NoContainerEnabled = -6
    };
    ...
    */
    virtual StartRecordingResult StartRecording(const std::string &jsonOptions, bool persistOptions);
    ...
    */
    ...
    /**
    @return JSON string containing current recording options.
    */
    virtual std::string RecordingOptions();
    ...
    */
    virtual int LastRecordedFrameIndex();
