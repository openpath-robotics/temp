...
//    }
    ...
    HardwareIdentification = "2019-11-048-LC3";
...
//        std::cout << SampleFrame->PointCloud.GetDataSize() << std::endl;
        std::cout << RawPointer->x << std::endl;
//        for(int idx=0; idx<SampleFrame->PointCloud.GetDataSize(); idx++)
//        {
//            std::cout << MyLocalCopy[idx] << std::endl;
//        }
